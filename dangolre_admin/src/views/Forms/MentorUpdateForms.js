...
import { regExp_sign, regExp_space } from 'util.js';
...
export default function MentorUpdateForms(props) {

  console.log('MentorUpdateForms props :', props);
  ...
  // 메인 데이터 체크
  const [idState, setIdState] = useState("success");
  const [nameState, setNameState] = useState("success");
  const [ageState, setAgeState] = useState("success");
  const [locationState, setLocationState] = useState("success");
  const [categoryState, setCategoryState] = useState("success");
  const [descriptionState, setDescriptionState] = useState("success");
  const [imagePathState, setImagePathState] = useState("success");
  ...
  // 상세 데이터 체크
  const [titleImagePathState, setTitleImagePathState] = useState("success");
  const [faceImagePathState, setFaceImagePathState] = useState("success");
  const [locationDescState, setLocationDescState] = useState("success");
  const [titleDescState, setTitleDescState] = useState("success");
  const [tagKeywordState, setTagKeywordState] = useState("success");
  const [phoneNumberState, setPhoneNumberState] = useState("success");
  const [introTitleState1, setIntroTitleState1] = useState("success");
  const [introQuoteState1, setIntroQuoteState1] = useState("success");
  const [introQuoteSubState1, setIntroQuoteSubState1] = useState("success");
  const [introDescState1, setIntroDescState1] = useState("success");
  const [introImagePathState1, setIntroImagePathState1] = useState("success");
  const [introTitleState2, setIntroTitleState2] = useState("success");
  const [introQuoteState2, setIntroQuoteState2] = useState("success");
  const [introQuoteSubState2, setIntroQuoteSubState2] = useState("success");
  const [introDescState2, setIntroDescState2] = useState("success");
  const [introImagePathState2, setIntroImagePathState2] = useState("success");
  const [achievementsState1, setAchievementsState1] = useState("success");
  const [consultCaseTitleState1, setConsultCaseTitleState1] = useState("success");
  const [consultCaseQuoteState1, setConsultCaseQuoteState1] = useState("success");
  const [consultCaseQuoteSubState1, setConsultCaseQuoteSubState1] = useState("success");
  const [consultCaseDescState1, setConsultCaseDescState1] = useState("success");
  const [consultCaseURLState1, setConsultCaseURLState1] = useState("success");
  const [consultCaseTitleState2, setConsultCaseTitleState2] = useState("success");
  const [consultCaseQuoteState2, setConsultCaseQuoteState2] = useState("success");
  const [consultCaseQuoteSubState2, setConsultCaseQuoteSubState2] = useState("success");
  const [consultCaseDescState2, setConsultCaseDescState2] = useState("success");
  const [consultCaseURLState2, setConsultCaseURLState2] = useState("success");
  const [consultCaseTitleState3, setConsultCaseTitleState3] = useState("success");
  const [consultCaseQuoteState3, setConsultCaseQuoteState3] = useState("success");
  const [consultCaseQuoteSubState3, setConsultCaseQuoteSubState3] = useState("success");
  const [consultCaseDescState3, setConsultCaseDescState3] = useState("success");
  const [consultCaseURLState3, setConsultCaseURLState3] = useState("success");
  const [introVideoURLState, setIntroVideoURLState] = useState("success");
  const [addressTextState, setAddressTextState] = useState("success");
  const [addressNaverState, setAddressNaverState] = useState("success");
  const [addresskakaoState, setAddresskakaoState] = useState("success");
  ...
  const [isLoadMain, setIsLoadMain] = React.useState(false);
  const [isLoadDetail, setIsLoadDetail] = React.useState(false);
  const [isInputPossible, setIsInputPossible] = React.useState(false);

  const { mentorMainMemberActions, mentorDetailMemberActions } = props;

  const dataLoadClick = () => {

    if( id === "" || idState === ""){
      alert('아이디를 먼저 입력하고 찾기 버튼을 눌러주세요!');

    } else {

      mentorMainMemberActions(id).then( (res) => {

        if(res.error){
          alert('없는 아이디 같습니다! 다시 한번 아이디를 확인해주세요!');
        } else {
          setIsLoadMain(true);
        }
      });

      mentorDetailMemberActions(id).then( (res) => {
  ...
  React.useEffect(() => {
    ...
    if( Object.keys(query).length !== 0 ){
      ...
      mentorMainMemberActions(query.id).then( (res) => {
      ...
      mentorDetailMemberActions(query.id).then( (res) => {
  ...
  const { mentorMainData, mentorDetailData } = props;

  if( isLoadMain ){

    setIsLoadMain(false);

    setId(mentorMainData.id);
    setName(mentorMainData.name);
    setAge(mentorMainData.age);
    setLocation(mentorMainData.location);
    setCategory(mentorMainData.category);
    setDescription(mentorMainData.description);
    setImagePath(mentorMainData.imagePath);
  }
  ...
  if( isLoadDetail ){
    ...
    setTitleImagePath(mentorDetailData.titleImagePath);
    setFaceImagePath(mentorDetailData.faceImagePath);
    setLocationDesc(mentorDetailData.locationDesc);
    setNaverBlogURL(mentorDetailData.naverBlogURL);
    setYoutubeURL(mentorDetailData.youtubeURL);
    setInstagramURL(mentorDetailData.instagramURL);
    setFacebookURL(mentorDetailData.facebookURL);
    setTitleDesc(mentorDetailData.titleDesc);
    setTagKeyword(mentorDetailData.tagKeyword);
    setPhoneNumber(mentorDetailData.phoneNumber);
    setIntroTitle1(mentorDetailData.introTitle1);
    setIntroQuote1(mentorDetailData.introQuote1);
    setIntroQuoteSub1(mentorDetailData.introQuoteSub1);
    setIntroDesc1(mentorDetailData.introDesc1);
    setIntroImagePath1(mentorDetailData.introImagePath1);
    setIntroTitle2(mentorDetailData.introTitle2);
    setIntroQuote2(mentorDetailData.introQuote2);
    setIntroQuoteSub2(mentorDetailData.introQuoteSub2);
    setIntroDesc2(mentorDetailData.introDesc2);
    setIntroImagePath2(mentorDetailData.introImagePath2);
    setAchievements1(mentorDetailData.achievements1);
    setAchievements2(mentorDetailData.achievements2);
    setAchievements3(mentorDetailData.achievements3);
    setAchievements4(mentorDetailData.achievements4);
    setAchievements5(mentorDetailData.achievements5);
    setConsultCaseTitle1(mentorDetailData.consultCaseTitle1);
    setConsultCaseQuote1(mentorDetailData.consultCaseQuote1);
    setConsultCaseQuoteSub1(mentorDetailData.consultCaseQuoteSub1);
    setConsultCaseDesc1(mentorDetailData.consultCaseDesc1);
    setConsultCaseURL1(mentorDetailData.consultCaseURL1);
    setConsultCaseTitle2(mentorDetailData.consultCaseTitle2);
    setConsultCaseQuote2(mentorDetailData.consultCaseQuote2);
    setConsultCaseQuoteSub2(mentorDetailData.consultCaseQuoteSub2);
    setConsultCaseDesc2(mentorDetailData.consultCaseDesc2);
    setConsultCaseURL2(mentorDetailData.consultCaseURL2);
    setConsultCaseTitle3(mentorDetailData.consultCaseTitle3);
    setConsultCaseQuote3(mentorDetailData.consultCaseQuote3);
    setConsultCaseQuoteSub3(mentorDetailData.consultCaseQuoteSub3);
    setConsultCaseDesc3(mentorDetailData.consultCaseDesc3);
    setConsultCaseURL3(mentorDetailData.consultCaseURL3);
    setIntroVideoURL(mentorDetailData.introVideoURL);
    setAddressText(mentorDetailData.addressText);
    setAddressNaver(mentorDetailData.addressNaver);
    setAddresskakao(mentorDetailData.addresskakao);

    setIsInputPossible(true);
  }
  ...
  const dataSaveClick = () => {
    ...
    if (idState === "error" || id === "" || nameState === "error" || name === "" || ageState === "error" || age === "" || locationState === "error" || location === "" ||
      ...
      const { mentorMainUpdateActions, mentorDetailUpdateActions } = props;

      mentorMainUpdateActions(id, dataMain, onSaveFinishMain, onSaveFailureMain);
      mentorDetailUpdateActions(id, dataDetail, onSaveFinishDetail, onSaveFailureDetail);
    }
  };

  const onSaveFinishMain = (res) => {
    //console.log('onSaveFinishMain :', res);
    //alert('메인 데이터 수정에 성공하였습니다!\n데이터 목록 화면으로 넘어가겠습니다!');
    setIsSaveDone(true);
  }
  const onSaveFailureMain = (res) => {
    //console.log('onSaveFailureMain :', res);
    alert('메인 데이터 수정에 실패하였습니다!\n아이디 중복이나 입력 실수가 있는지 확인해주세요!');
  }

  const onSaveFinishDetail = (res) => {
    //console.log('onSaveFinishDetail :', res);
    //alert('데이터 수정에 성공하였습니다!\n데이터 목록 화면으로 넘어가겠습니다!');
    setIsSaveDone(true);
  }
  const onSaveFailureDetail = (res) => {
    //console.log('onSaveFailureDetail :', res);
    alert('상세 데이터 수정에 실패하였습니다!\n아이디 중복이나 입력 실수가 있는지 확인해주세요!');
  }

  const classes = useStyles();

  // 수정 완료되면 목록 화면으로 넘어가기
  if( isSaveDone === true ){
    alert('데이터 수정에 성공하였습니다!\n데이터 목록 화면으로 넘어가겠습니다!');
    return <Redirect from="/admin/data-update" to="/admin/data-list" />;
  }
    ...
    <GridContainer>
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="rose" text>
            <CardText color="rose">
              <h4 className={classes.cardTitle}>메인 데이터 수정</h4>
            </CardText>
          </CardHeader>
          <CardBody>
            <form>
              <GridContainer>
                ...
                <GridItem xs={12} sm={10}>
                  ...
                  />
                  <Button disabled={props.loadingMainData || props.loadingDetailData} color="rose" onClick={dataLoadClick}>
                    아이디로 찾기
                  </Button>
                </GridItem>
              </GridContainer>
              <GridContainer>
                ...
                <GridItem xs={12} sm={10}>
                  <CustomInput
                    ...
                    inputProps={{
                      disabled: isInputPossible ? false : true,
                      value: name,
        ...
        <Card>
          <CardHeader color="primary" text>
            <CardText color="primary">
              <h4 className={classes.cardTitle}>상세 데이터 수정 1</h4>
            </CardText>
          </CardHeader>
          <CardBody>
            <form>
              <GridContainer>
                ...
                <GridItem xs={12} sm={10}>
                  <ImageUpload
                    ...
                    imageCurrentUrl={titleImagePath}
                    onUploadEnd={ (url) => {
                      if (url) {
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={10}>
                  <ImageUpload
                    ...
                    imageCurrentUrl={introImagePath1}
                    onUploadEnd={ (url) => {
                      if (url) {
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={10}>
                  <ImageUpload
                    ...
                    imageCurrentUrl={introImagePath2}
                    onUploadEnd={ (url) => {
                      if (url) {
      ...
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary" text>
            <CardText color="primary">
              <h4 className={classes.cardTitle}>상세 데이터 수정 2</h4>
            </CardText>
          </CardHeader>
          <CardBody>
            <form>
          ...
          <CardFooter className={classes.justifyContentCenter}>
            <Button disabled={props.loadingMainData || props.loadingDetailData || isInputPossible === false} color="rose" onClick={dataSaveClick}>
              수정 하기
            </Button>
          </CardFooter>
        </Card>
